...
const Navbar_responsive = () =>{
    ...
    <div className=" navbar-start">
      ...
      <Link to="/"><img className="w-8 h-12 ml-64" src={logo} alt="" /></Link>
    </div>
  ...
  <div className='fixed top-0 left-0 w-full pr-5 text-sm font-bold text-white franklin right-20 md-m:hidden'>
   <div className="w-10 h-8 pt-3"> <Link to="/"> <img src={logo} alt="Logo Ramiro Gumma frontend developer" /></Link></div>
